...
class ApplyBundledTemplate : AnAction() {
...
class CxLoggersContextMenuActionGroup : ActionGroup(), DumbAware {
    ...
    override fun getChildren(e: AnActionEvent?): Array<AnAction> {
        ...
        return when (selectedNode) {
            is BundledLoggersTemplateLoggersOptionsNode -> arrayOf(ApplyBundledTemplate())
            is CustomLoggersTemplateLoggersOptionsNode -> arrayOf(ApplyBundledTemplate())
            else -> emptyArray()
        }
    }
