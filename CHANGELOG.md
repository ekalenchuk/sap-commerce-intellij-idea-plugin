...
- 16 PR(s) by [Eugeni Kalenchuk](https://github.com/epam/sap-commerce-intellij-idea-plugin/pulls?q=milestone%3A2026.2.5+author%3Aekalenchuk+is%3Apr)
...
- Highlight the remote properties whose value differs from the project, explaining the difference on hover [#2006](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/2006)
- Copy a property name or value from its context menu [#2007](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/2007)
...
- Report a password, token or API key written into a committed `project.properties` [#2019](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/2019)
- Compare two remote instances with each other, listing what only one of them has and what they disagree about [#2020](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/2020)
