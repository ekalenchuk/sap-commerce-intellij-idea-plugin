...
import sap.commerce.toolset.flexibleSearch.editor.FlexibleSearchIntroduceBindParametersService
...
class FlexibleSearchIntroduceBindParametersAction : DumbAwareAction() {
    ...
    override fun update(e: AnActionEvent) = e.ifNotFromSearchPopup {
        ...
        e.presentation.icon = HybrisIcons.FlexibleSearch.Actions.INTRODUCE_BIND_PARAMETERS
        e.presentation.isEnabled = e.flexibleSearchSplitEditor() != null
    }

    override fun actionPerformed(e: AnActionEvent) {
        val project = e.project ?: return
        val fileEditor = e.flexibleSearchSplitEditor() ?: return

        FlexibleSearchIntroduceBindParametersService.getInstance(project).introduceBindParameters(fileEditor)
    }
}
