...
/** Deletes a declaration which never applies, since the only thing it does is mislead whoever reads the file. */
class CxRemovePropertyDeclarationFix : LocalQuickFix {

    override fun getFamilyName() = "Remove the declaration"
